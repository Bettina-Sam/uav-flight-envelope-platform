...
export default function App() {
  return (
    <ThemeProvider>
      <LanguageProvider>
      <UAVProvider>
        <div className="min-h-screen min-w-0 flex flex-col relative overflow-x-clip">
          <AnimatedBackground />
          <Navbar />
          <main className="flex-1 min-w-0 max-w-7xl w-full mx-auto px-3 sm:px-6 py-6 sm:py-10">
            <AnimatedRoutes />
          </main>
          <Footer />
        </div>
