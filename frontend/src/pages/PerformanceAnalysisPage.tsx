  ...
  return (
    <div>
      ...
      <p className="text-muted text-sm mb-6 max-w-2xl">
        Physics, machine-learning comparison, sensitivity, and optimization focused on the two
        mission outputs: how far the UAV can travel and how long it can remain airborne.
      </p>
        ...
        <motion.div key={tab} initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
          {tab === 'range' ? (
            <MetricDeepDivePage
              ...
              title="Range"
              unit="range value"
              accentDesc="Direct cruise-speed × endurance range convention used by this project."
            ...
            <MetricDeepDivePage
              ...
              title="Endurance"
              unit="hr"
              accentDesc="How long the UAV can remain airborne from its usable fuel or battery energy."
